...
export default function CaseStudyCard({
  ...
  return (
    <>
      <style>{`
        .cs-card { container-type: inline-size; container-name: cs-card; height: 100%; }
      ...
      <div className="cs-card">
        ...
        >
          {/* Content column: title at top, spacer grows, metadata at bottom */}
          <div style={{ flex: 1, minWidth: 0, display: "flex", flexDirection: "column" }}>
            <p style={{ fontSize: isMobile ? 15 : 20, fontWeight: 600, lineHeight: 1.3, margin: 0 }}>{title}</p>
          ...
          {!isMobile && (
            <div style={{ flexShrink: 0, display: "flex", alignItems: "center", paddingLeft: 32 }}>
              <div style={{
